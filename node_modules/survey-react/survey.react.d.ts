/*Type definitions for Survey JavaScript library v1.0.16
...
export declare class ConditionsParser {
    readonly ERROR_OperatorExpected: string;
    readonly ERROR_RightPartExpected: string;
    readonly ERROR_ExpressionExpected: string;
    readonly ERROR_EndExpected: string;
    parse(text: string, root: ConditionNode): boolean;
    createCondition(text: string): ConditionNode;
...
/**
    ...
    */
export declare class QuestionMatrixModel extends Question implements IMatrixData, IMatrixCellsOwner {
        name: string;
        constructor(name: string);
        getType(): string;
        readonly isAllowTitleLeft: boolean;
...
export declare class QuestionFileModel extends Question {
        ...
        protected setFilesValue(files: File[]): void;
        protected onCheckForErrors(errors: Array<SurveyError>): void;
}
...
export declare class SurveyModel extends Base implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ILocalizableOwner {
        ...
        protected currentPageChanging(newValue: PageModel, oldValue: PageModel): void;
